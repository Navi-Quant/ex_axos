defmodule ExAxos.AccountGenerationAccountDigest do
  @moduledoc """
  Provides struct and type for a AccountGenerationAccountDigest
  """
  ...
  @type t :: %__MODULE__{
          ...
          jointPii: ExAxos.AccountPIIDigest.t() | nil,
          ...
          pii: ExAxos.AccountPIIDigest.t() | nil,
  ...
  def __fields__(:t) do
    [
      ...
      jointPii: {ExAxos.AccountPIIDigest, :t},
