defmodule ExAxos.AccountMaintenance do
  ...
  def generate_account_v1_using_post(body, opts \\ []) do
    ...
    client.request(%{
      args: [body: body],
      call: {ExAxos.AccountMaintenance, :generate_account_v1_using_post},
  ...
  def update_account_beneficiary_v1_using_post(accountNumber, body, opts \\ []) do
    ...
    client.request(%{
      ...
      call: {ExAxos.AccountMaintenance, :update_account_beneficiary_v1_using_post},
  ...
  def update_account_fee_v1_using_post(accountNumber, body, opts \\ []) do
    ...
    client.request(%{
      args: [accountNumber: accountNumber, body: body],
      call: {ExAxos.AccountMaintenance, :update_account_fee_v1_using_post},
  ...
  def update_account_model_v1_using_post(accountNumber, body, opts \\ []) do
    ...
    client.request(%{
      args: [accountNumber: accountNumber, body: body],
      call: {ExAxos.AccountMaintenance, :update_account_model_v1_using_post},
  ...
  def update_account_representative_v1_using_post(accountNumber, body, opts \\ []) do
    ...
    client.request(%{
      args: [accountNumber: accountNumber, body: body],
      call: {ExAxos.AccountMaintenance, :update_account_representative_v1_using_post},
  ...
  def update_account_v1_using_post(accountNumber, body, opts \\ []) do
    ...
    client.request(%{
      args: [accountNumber: accountNumber, body: body],
      call: {ExAxos.AccountMaintenance, :update_account_v1_using_post},
