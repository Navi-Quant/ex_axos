defmodule ExAxos.AccountTransactionsAPI do
  @moduledoc """
  Provides API endpoints related to account transactions api
  """
  ...
  def view_transactions_by_date_range_v1_using_get(
    ...
    client.request(%{
      ...
      call: {ExAxos.AccountTransactionsAPI, :view_transactions_by_date_range_v1_using_get},
      url:
  ...
  def view_transactions_v1_using_get(accountNumber, opts \\ []) do
    ...
    client.request(%{
      ...
      call: {ExAxos.AccountTransactionsAPI, :view_transactions_v1_using_get},
