defmodule ExAxos.AccountPositionsAPI do
  @moduledoc """
  Provides API endpoints related to account positions api
  """
  ...
  def retrieve_statement_family_positions_v1_using_get(statementFamilyId, opts \\ []) do
    ...
    client.request(%{
      ...
      call: {ExAxos.AccountPositionsAPI, :retrieve_statement_family_positions_v1_using_get},
  ...
  def view_positions_by_statement_family_id_v1_using_get(statementFamilyId, opts \\ []) do
    ...
    client.request(%{
      args: [statementFamilyId: statementFamilyId],
      call: {ExAxos.AccountPositionsAPI, :view_positions_by_statement_family_id_v1_using_get},
  ...
  def view_positions_detail_v1_using_get(accountNumber, opts \\ []) do
    ...
    client.request(%{
      ...
      call: {ExAxos.AccountPositionsAPI, :view_positions_detail_v1_using_get},
