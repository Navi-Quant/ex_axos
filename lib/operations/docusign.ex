defmodule ExAxos.Docusign do
  ...
  def create_envelope_using_post(sobo, body, opts \\ []) do
    ...
    client.request(%{
      ...
      call: {ExAxos.Docusign, :create_envelope_using_post},
  ...
  def retrieve_brands_using_get(opts \\ []) do
    ...
    client.request(%{
      args: [],
      call: {ExAxos.Docusign, :retrieve_brands_using_get},
  ...
  def retrieve_envelopes_from_user_folder_using_get(folderId, sobo, opts \\ []) do
    ...
    client.request(%{
      ...
      call: {ExAxos.Docusign, :retrieve_envelopes_from_user_folder_using_get},
  ...
  def retrieve_user_folders_using_get(sobo, opts \\ []) do
    ...
    client.request(%{
      args: [sobo: sobo],
      call: {ExAxos.Docusign, :retrieve_user_folders_using_get},
