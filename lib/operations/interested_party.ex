defmodule ExAxos.InterestedParty do
  ...
  """
  @spec disassocate_interested_party_using_put(ExAxos.Schema.InterestedPartyId.t(), keyword) ::
  ...
  def disassocate_interested_party_using_put(body, opts \\ []) do
    ...
    client.request(%{
      args: [body: body],
      call: {ExAxos.InterestedParty, :disassocate_interested_party_using_put},
  ...
  """
  @spec save_interested_party_by_account_v2_using_put(
          ExAxos.Schema.InterestedPartyRest2.t(),
          keyword
        ) :: {:ok, ExAxos.Schema.AccountInterestedPartyResponseDigest.t()} | :error
  def save_interested_party_by_account_v2_using_put(body, opts \\ []) do
    ...
    client.request(%{
      args: [body: body],
      call: {ExAxos.InterestedParty, :save_interested_party_by_account_v2_using_put},
  ...
  def view_interested_party_by_account_v1_using_get(accountNumber, opts \\ []) do
    ...
    client.request(%{
      ...
      call: {ExAxos.InterestedParty, :view_interested_party_by_account_v1_using_get},
