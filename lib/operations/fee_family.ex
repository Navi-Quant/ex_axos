defmodule ExAxos.FeeFamily do
  ...
  def fee_family_lookup_v1_using_get(feeFamilyId, opts \\ []) do
    ...
    client.request(%{
      ...
      call: {ExAxos.FeeFamily, :fee_family_lookup_v1_using_get},
  ...
  def fee_schedule_lookup_v1_using_get(feeScheduleId, opts \\ []) do
    ...
    client.request(%{
      ...
      call: {ExAxos.FeeFamily, :fee_schedule_lookup_v1_using_get},
  ...
  def fetch_all_fees_by_account_type_v1_using_get(accountType, opts \\ []) do
    ...
    client.request(%{
      ...
      call: {ExAxos.FeeFamily, :fetch_all_fees_by_account_type_v1_using_get},
  ...
  def fetch_all_fees_v1_using_get(opts \\ []) do
    ...
    client.request(%{
      args: [],
      call: {ExAxos.FeeFamily, :fetch_all_fees_v1_using_get},
  ...
  def fetch_fee_families_v1_using_get(opts \\ []) do
    ...
    client.request(%{
      args: [],
      call: {ExAxos.FeeFamily, :fetch_fee_families_v1_using_get},
