defmodule ExAxos.Schema.SecurityBasicDigest do
  @moduledoc """
  Provides struct and type for a Schema.SecurityBasicDigest
  """

  @type t :: %__MODULE__{
          assetClass: ExAxos.Schema.AssetClassDigest.t() | nil,
          assetType: ExAxos.Schema.AssetTypeDigest.t() | nil,
          ...
          subAssetClass: ExAxos.Schema.SubAssetClassDigest.t() | nil,
          symbol: String.t() | nil,
  ...
  def __fields__(:t) do
    [
      assetClass: {ExAxos.Schema.AssetClassDigest, :t},
      assetType: {ExAxos.Schema.AssetTypeDigest, :t},
      ...
      subAssetClass: {ExAxos.Schema.SubAssetClassDigest, :t},
