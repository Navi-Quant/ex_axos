defmodule ExAxos.Schema.FeeScheduleRestDigest do
  @moduledoc """
  Provides struct and type for a Schema.FeeScheduleRestDigest
  """
  ...
  @type t :: %__MODULE__{
          ...
          models: [ExAxos.Schema.ModelDigest.t()] | nil,
  ...
  def __fields__(:t) do
    [
      ...
      models: [{ExAxos.Schema.ModelDigest, :t}],
      modelsCount: :integer,
