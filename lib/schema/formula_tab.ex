defmodule ExAxos.Schema.FormulaTab do
  @moduledoc """
  Provides struct and type for a Schema.FormulaTab
  """
  ...
  def __fields__(:t) do
    [
      ...
      formula: {:string, :generic},
      isPaymentAmount: {:string, :generic},
